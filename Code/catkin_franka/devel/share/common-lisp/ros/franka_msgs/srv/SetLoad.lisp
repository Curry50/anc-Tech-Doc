...
(cl:defmethod cl:initialize-instance :after ((m <SetLoad-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetLoad-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name franka_msgs-srv:<SetLoad-request> is deprecated: use franka_msgs-srv:SetLoad-request instead.")))

(cl:ensure-generic-function 'mass-val :lambda-list '(m))
(cl:defmethod mass-val ((m <SetLoad-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader franka_msgs-srv:mass-val is deprecated.  Use franka_msgs-srv:mass instead.")
  (mass m))

(cl:ensure-generic-function 'F_x_center_load-val :lambda-list '(m))
(cl:defmethod F_x_center_load-val ((m <SetLoad-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader franka_msgs-srv:F_x_center_load-val is deprecated.  Use franka_msgs-srv:F_x_center_load instead.")
  (F_x_center_load m))

(cl:ensure-generic-function 'load_inertia-val :lambda-list '(m))
(cl:defmethod load_inertia-val ((m <SetLoad-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader franka_msgs-srv:load_inertia-val is deprecated.  Use franka_msgs-srv:load_inertia instead.")
  (load_inertia m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetLoad-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetLoad-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name franka_msgs-srv:<SetLoad-response> is deprecated: use franka_msgs-srv:SetLoad-response instead.")))
