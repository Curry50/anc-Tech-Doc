...
(cl:defmethod cl:initialize-instance :after ((m <SetEEFrame-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetEEFrame-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name franka_msgs-srv:<SetEEFrame-request> is deprecated: use franka_msgs-srv:SetEEFrame-request instead.")))

(cl:ensure-generic-function 'NE_T_EE-val :lambda-list '(m))
(cl:defmethod NE_T_EE-val ((m <SetEEFrame-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader franka_msgs-srv:NE_T_EE-val is deprecated.  Use franka_msgs-srv:NE_T_EE instead.")
  (NE_T_EE m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SetEEFrame-request>)))
  ...
  "459aea8fa6dbdd34ba4bc52d3eddbacf")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SetEEFrame-request)))
  "Returns md5sum for a message object of type 'SetEEFrame-request"
  "459aea8fa6dbdd34ba4bc52d3eddbacf")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SetEEFrame-request>)))
  ...
  (cl:format cl:nil "float64[16] NE_T_EE~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SetEEFrame-request)))
  "Returns full string definition for message of type 'SetEEFrame-request"
  (cl:format cl:nil "float64[16] NE_T_EE~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <SetEEFrame-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetEEFrame-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name franka_msgs-srv:<SetEEFrame-response> is deprecated: use franka_msgs-srv:SetEEFrame-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetEEFrame-response>)))
  ...
  "franka_msgs/SetEEFrameResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetEEFrame-response)))
  "Returns string type for a service object of type 'SetEEFrame-response"
  "franka_msgs/SetEEFrameResponse")
