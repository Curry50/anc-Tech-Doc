...
(cl:defmethod cl:initialize-instance :after ((m <SetKFrame-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetKFrame-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name franka_msgs-srv:<SetKFrame-request> is deprecated: use franka_msgs-srv:SetKFrame-request instead.")))

(cl:ensure-generic-function 'EE_T_K-val :lambda-list '(m))
(cl:defmethod EE_T_K-val ((m <SetKFrame-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader franka_msgs-srv:EE_T_K-val is deprecated.  Use franka_msgs-srv:EE_T_K instead.")
  (EE_T_K m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetKFrame-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetKFrame-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name franka_msgs-srv:<SetKFrame-response> is deprecated: use franka_msgs-srv:SetKFrame-response instead.")))
