...
class Errors {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.cartesian_spline_motion_generator_violation = null;
      this.joint_via_motion_generator_planning_joint_limit_violation = null;
      this.base_acceleration_initialization_timeout = null;
      this.base_acceleration_invalid_reading = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('cartesian_spline_motion_generator_violation')) {
        this.cartesian_spline_motion_generator_violation = initObj.cartesian_spline_motion_generator_violation
      }
      else {
        this.cartesian_spline_motion_generator_violation = false;
      }
      if (initObj.hasOwnProperty('joint_via_motion_generator_planning_joint_limit_violation')) {
        this.joint_via_motion_generator_planning_joint_limit_violation = initObj.joint_via_motion_generator_planning_joint_limit_violation
      }
      else {
        this.joint_via_motion_generator_planning_joint_limit_violation = false;
      }
      if (initObj.hasOwnProperty('base_acceleration_initialization_timeout')) {
        this.base_acceleration_initialization_timeout = initObj.base_acceleration_initialization_timeout
      }
      else {
        this.base_acceleration_initialization_timeout = false;
      }
      if (initObj.hasOwnProperty('base_acceleration_invalid_reading')) {
        this.base_acceleration_invalid_reading = initObj.base_acceleration_invalid_reading
      }
      else {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [cartesian_spline_motion_generator_violation]
    bufferOffset = _serializer.bool(obj.cartesian_spline_motion_generator_violation, buffer, bufferOffset);
    // Serialize message field [joint_via_motion_generator_planning_joint_limit_violation]
    bufferOffset = _serializer.bool(obj.joint_via_motion_generator_planning_joint_limit_violation, buffer, bufferOffset);
    // Serialize message field [base_acceleration_initialization_timeout]
    bufferOffset = _serializer.bool(obj.base_acceleration_initialization_timeout, buffer, bufferOffset);
    // Serialize message field [base_acceleration_invalid_reading]
    bufferOffset = _serializer.bool(obj.base_acceleration_invalid_reading, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [cartesian_spline_motion_generator_violation]
    data.cartesian_spline_motion_generator_violation = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [joint_via_motion_generator_planning_joint_limit_violation]
    data.joint_via_motion_generator_planning_joint_limit_violation = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [base_acceleration_initialization_timeout]
    data.base_acceleration_initialization_timeout = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [base_acceleration_invalid_reading]
    data.base_acceleration_invalid_reading = _deserializer.bool(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.cartesian_spline_motion_generator_violation !== undefined) {
      resolved.cartesian_spline_motion_generator_violation = msg.cartesian_spline_motion_generator_violation;
    }
    else {
      resolved.cartesian_spline_motion_generator_violation = false
    }

    if (msg.joint_via_motion_generator_planning_joint_limit_violation !== undefined) {
      resolved.joint_via_motion_generator_planning_joint_limit_violation = msg.joint_via_motion_generator_planning_joint_limit_violation;
    }
    else {
      resolved.joint_via_motion_generator_planning_joint_limit_violation = false
    }

    if (msg.base_acceleration_initialization_timeout !== undefined) {
      resolved.base_acceleration_initialization_timeout = msg.base_acceleration_initialization_timeout;
    }
    else {
      resolved.base_acceleration_initialization_timeout = false
    }

    if (msg.base_acceleration_invalid_reading !== undefined) {
      resolved.base_acceleration_invalid_reading = msg.base_acceleration_invalid_reading;
    }
    else {
      resolved.base_acceleration_invalid_reading = false
    }
