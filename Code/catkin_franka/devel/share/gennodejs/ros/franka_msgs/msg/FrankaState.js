...
class FrankaState {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('O_ddP_O')) {
        this.O_ddP_O = initObj.O_ddP_O
      }
      else {
        this.O_ddP_O = new Array(3).fill(0);
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Check that the constant length array field [O_ddP_O] has the right length
    if (obj.O_ddP_O.length !== 3) {
      throw new Error('Unable to serialize array field O_ddP_O - length must be 3')
    }
    // Serialize message field [O_ddP_O]
    bufferOffset = _arraySerializer.float64(obj.O_ddP_O, buffer, bufferOffset, 3);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [O_ddP_O]
    data.O_ddP_O = _arrayDeserializer.float64(buffer, bufferOffset, 3)
  ...
  static Resolve(msg) {
    ...
    if (msg.O_ddP_O !== undefined) {
      resolved.O_ddP_O = msg.O_ddP_O;
    }
    else {
      resolved.O_ddP_O = new Array(3).fill(0)
    }
